...
description: Design and architect enterprise-grade, scalable web applications that handle millions of users. Use when planning system architecture, choosing tech stacks, designing databases, implementing microservices, setting up CI/CD, or making critical architectural decisions for production applications. Provides battle-tested patterns for high-traffic systems.
---
...
Design robust, scalable, and maintainable software systems following enterprise architecture principles:
