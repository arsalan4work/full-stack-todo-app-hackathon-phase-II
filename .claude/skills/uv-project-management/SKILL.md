...
description: UV is an extremely fast Python package and project manager written in Rust. It replaces pip, virtualenv, poetry, and pyenv with a single tool that's 10-100x faster.
----
