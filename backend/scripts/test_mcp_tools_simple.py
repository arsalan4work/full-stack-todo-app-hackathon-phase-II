"""Simple test script to verify MCP task tools functionality."""
import sys
import os
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Import the tools directly to test functionality
...
def test_mcp_task_tools():
    ...
    # Test title too long
    long_title_result = add_task(user_id=test_user_id, title="A"*300, description="Test")
    ...
    nonexistent_task_result = complete_task(user_id=test_user_id, task_id=99999)
